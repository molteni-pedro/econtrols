 ...
 */
function econtrolszen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['econtrolszen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('econtrolszen sample setting'),
  '#default_value' => theme_get_setting('econtrolszen_example'),
