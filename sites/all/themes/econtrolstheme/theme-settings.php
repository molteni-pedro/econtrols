 ...
 */
function econtrolstheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['econtrolstheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('econtrolstheme sample setting'),
  '#default_value' => theme_get_setting('econtrolstheme_example'),
